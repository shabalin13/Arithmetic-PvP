        ...
        <div class="card-body">
            ...
            <form class="row gx-1" @submit.prevent="submitForm">
                ...
                <div class="form-floating mb-2">
                    <input type="email" class="form-control" id="floatingInput" v-model="email" placeholder="email" required>
                    <label for="floatingInput">Email address</label>
                </div>
                <div class="form-floating col-6 mb-3">
                    <input type="password" class="form-control" id="floatingPassword1" v-model="password" placeholder="password1" required>
                    <label for="floatingPassword1">Password</label>
                </div>
                <div class="form-floating col-6 mb-3">
                    <input type="password" class="form-control" id="floatingPassword2" v-model="password2" placeholder="password2" required>
                ...
                <div><button class="w-100 btn btn-lg btn-dark" type="submit">Sign up</button></div>

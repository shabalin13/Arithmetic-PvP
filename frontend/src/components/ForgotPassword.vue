  ...
  <div class="card card1">
                <div class="row justify-content-center my-auto">
                    <div class="col-md-8 col-10 my-5">
                        ...
                        <h6 class="msg-info">To restore your account, please fill in the following fields</h6>
                      <form v-on:submit.prevent="submitForm">
                        <div class="form-group"> <label class="form-control-label text-muted">Username</label> <input type="text" class="form-control input-text" id="username" v-model="username" placeholder="Username" required> </div>
                        <div class="form-group"> <label class="form-control-label text-muted">Email</label> <input type="text" class="form-control input-text" id="email" v-model="email" placeholder="Email" required> </div>
                        <div class="row justify-content-center my-3 px-3"> <button class="btn-block btn-color" type="submit">Restore</button> </div>
                      </form>
                    </div>
                </div>
            </div>

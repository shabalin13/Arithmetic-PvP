        ...
        <div>
          <b-dropdown variant="link" toggle-class="text-decoration-none" class="justify-content-center" right no-caret >
            <template #button-content>
              ...
              <b-dropdown-item href="/signUp"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white"
...
<!--           data-bs-toggle="dropdown" aria-expanded="false"><span class="dark-amber-text"><i-->
<!--    class="bi bi-list"></i></span>-->
<!--        </a>-->
...
<!--        </ul>-->
        ...
        <!--        <a class="colap" data-bs-toggle="collapse" href="#navbarToggleExternalContent" role="button"-->

    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark text-light px-3 py-2">
        <div class="me-auto">
            <a href="" class="d-flex align-items-center me-auto text-light text-decoration-none">
                <svg width="40" height="46" viewBox="0 0 84 97" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="ms-auto d-flex align-items-center">
            ...
            <button class="btn btn-outline-light mx-5"
                    data-clipboard-text="http://127.0.0.1:8000">Copy link</button>

            <a class="colap px-2" data-bs-toggle="collapse" href="#navbarToggleExternalContent" role="button"
               aria-expanded="false" aria-controls="navbarToggleExternalContent">
                <span class="dark-amber-text"><i class="bi bi-list"></i></span>
            </a>
...
-->
    ...
    <div class="pb-5">
        <h3 class="font-monospace pb-3">Player, share this link with your friends.</h3>

        <h3 class="font-monospace pb-3">Happy and successful game!</h3>
    </div>


    <h4 class="fst-italic">Joined players:</h4>
